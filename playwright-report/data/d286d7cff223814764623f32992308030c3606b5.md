...
- Name: cet-simulator.audit.spec.ts >> answer sheet synchronization and change limits >> answer sheet selection persists across refresh and blocks a fourth change
- Location: tests\e2e\cet-simulator.audit.spec.ts:208:3
...
Call log:
  - waiting for getByTestId('answer-1-A')
