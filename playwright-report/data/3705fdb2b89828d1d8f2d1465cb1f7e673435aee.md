...
- Name: cet-simulator.audit.spec.ts >> simulation leakage and responsive UI >> mobile portrait figures stay inside the viewport
- Location: tests\e2e\cet-simulator.audit.spec.ts:280:3
...
Locator: locator('img[src^="/assets/figures/"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('img[src^="/assets/figures/"]').first()
