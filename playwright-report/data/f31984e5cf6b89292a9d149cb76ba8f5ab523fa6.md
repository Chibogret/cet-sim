...
- Name: cet-simulator.audit.spec.ts >> answer sheet synchronization and change limits >> quick feedback keeps the answer sheet tight without horizontal overflow
- Location: tests\e2e\cet-simulator.audit.spec.ts:172:3
