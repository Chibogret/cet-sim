...
- Name: cet-simulator.audit.spec.ts >> answer sheet synchronization and change limits >> quick feedback colors paper view choices after answering
- Location: tests\e2e\cet-simulator.audit.spec.ts:190:3
...
Call log:
  - waiting for getByTestId('answer-1-B')
