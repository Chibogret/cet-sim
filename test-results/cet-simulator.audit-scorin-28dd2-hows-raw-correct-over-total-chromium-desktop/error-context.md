...
- Name: cet-simulator.audit.spec.ts >> scoring reliability >> right-minus-wrong off shows raw correct over total
- Location: tests\e2e\cet-simulator.audit.spec.ts:152:3
...
Locator: getByText(/Raw Correct/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Raw Correct/i)
