...
- Name: cet-simulator.audit.spec.ts >> simulation leakage and responsive UI >> header and answer sheet remain independently scrollable/fixed on desktop and iPad layouts
- Location: tests\e2e\cet-simulator.audit.spec.ts:252:3
...
Call log:
  - waiting for getByTestId('exam-header')
