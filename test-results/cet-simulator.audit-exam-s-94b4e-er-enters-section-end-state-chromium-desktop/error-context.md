...
- Name: cet-simulator.audit.spec.ts >> exam state and navigation reliability >> expired timer enters section-end state
- Location: tests\e2e\cet-simulator.audit.spec.ts:103:3
...
Locator: getByText(/Time is Up \/ Section Ended/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Time is Up \/ Section Ended/i)
