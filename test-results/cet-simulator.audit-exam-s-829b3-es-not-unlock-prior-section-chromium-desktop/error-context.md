...
- Name: cet-simulator.audit.spec.ts >> exam state and navigation reliability >> next section requires confirmation and browser Back does not unlock prior section
- Location: tests\e2e\cet-simulator.audit.spec.ts:112:3
...
Call log:
  - waiting for getByRole('button', { name: 'Next Section' })
